...
public class Colors {
    ...
    //? >= 1.21.2 {
    public static int loadingScreen = ARGB.color(255, 239, 50, 61); // ARGB.color(255, 239, 50, 61);
    ...
    //?} else {
    /*public static int loadingScreen = FastColor.ARGB32.color(255, 239, 50, 61); // ARGB.color(255, 239, 50, 61);
    public static int loadingScreenMonochrome = FastColor.ARGB32.color(255, 0, 0, 0);

    public static int socialInteractionsPlayerBackground = FastColor.ARGB32.color(255, 74, 74, 74);
    public static int socialInteractionsPlayerBackgroundHidden = FastColor.ARGB32.color(255, 48, 48, 48);
    *///?}
